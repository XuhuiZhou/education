...
class SLSTM(nn.Module):
    ...
    def __init__(self, hidden_size,dropout,step, gpu):
        #current
        ...
        self.Wxf1, self.Whf1, self.Wif1, self.Wdf1 = self.create_a_lstm_gate(hidden_size, self.training, gpu)
        #forget gate for right
        self.Wxf2, self.Whf2, self.Wif2, self.Wdf2 = self.create_a_lstm_gate(hidden_size, self.training, gpu)
        #forget gate for inital states
        self.Wxf3, self.Whf3, self.Wif3, self.Wdf3 = self.create_a_lstm_gate(hidden_size, self.training, gpu)
        #forget gate for dummy states
        self.Wxf4, self.Whf4, self.Wif4, self.Wdf4 = self.create_a_lstm_gate(hidden_size, self.training, gpu)
        #input gate for current state
        self.Wxi, self.Whi, self.Wii, self.Wdi = self.create_a_lstm_gate(hidden_size, self.training, gpu)
        #input gate for output gate
        self.Wxo, self.Who, self.Wio, self.Wdo = self.create_a_lstm_gate(hidden_size, self.training, gpu)
    ...
    def create_a_lstm_gate(self, hidden_size, is_training, gpu=False, mean=0.0, stddev=0.1):
        ...
        wif = self.create_to_hidden_variable(hidden_size, hidden_size, is_training, gpu, mean, stddev)
    ...
    def forward(self, word_inputs, mask, num_layers):
        ...
        embedding_hidden_state = initial_hidden_states.view(-1, self.hidden_size)  # 10*40, 600
